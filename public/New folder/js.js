jQuery(document).ready(function ($) {
    ...
    mywindow.scroll(function () {
        ...
        if ($('.navigation li[data-slide="1"],.navigation li[data-slide="2"], .navigation li[data-slide="3"],.navigation li[data-slide="5"],.navigation li[data-slide="6"],.navigation li[data-slide="8"],.navigation li[data-slide="9"],.navigation li[data-slide="11"]').hasClass('active')) {
        ...
        else if ($('.navigation li[data-slide="4"],.navigation li[data-slide="7"],.navigation li[data-slide="10"]').hasClass('active')) {
